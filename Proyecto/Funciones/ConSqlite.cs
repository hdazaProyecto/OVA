...
namespace Proyecto.Funciones
{
    public class ConSqlite
    {
        ...
        public ConSqlite(string _pmDBFileSqlite)
        {
        ...
        public SqlConnectionStringBuilder ConexionSQLServer()
        {
            ...
            this.reiniciarSql();
            con = new SqlConnectionStringBuilder();
            //con.DataSource = "192.168.1.18";//dt.Rows[0].Field<string>("cnfservidor");
            //con.InitialCatalog = "db";//dt.Rows[0].Field<string>("cnfbasedatos");
            //con.UserID = "syscom";//dt.Rows[0].Field<string>("cnfusuario");
            //con.Password = "u.owner";//dt.Rows[0].Field<string>("cnfclave");

            //conexion local
            con.DataSource = "(local)";//dt.Rows[0].Field<string>("cnfservidor");
            con.InitialCatalog = "dbproyecto";//dt.Rows[0].Field<string>("cnfbasedatos");
            con.UserID = "admin";//dt.Rows[0].Field<string>("cnfusuario");
            con.Password = "adminova";//dt.Rows[0].Field<string>("cnfclave");
